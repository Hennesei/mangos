...
BattleGround * BattleGroundMgr::CreateNewBattleGround(BattleGroundTypeId bgTypeId, PvPDifficultyEntry const* bracketEntry, ArenaType arenaType, bool isRated)
{
    ...
    {
        BattleGroundTypeId random_bgs[] = {BATTLEGROUND_WS, BATTLEGROUND_WS, BATTLEGROUND_AB, BATTLEGROUND_AB, BATTLEGROUND_EY, BATTLEGROUND_EY, BATTLEGROUND_AV, BATTLEGROUND_SA, BATTLEGROUND_SA, BATTLEGROUND_IC};
